...
def clean_ingredients(dish_name, dish_ingredients):
    ...
    final_ingredients = (dish_name,dish_ingredients_set)
...
def check_drinks(drink_name, drink_ingredients):
    ...
    if set(drink_ingredients).isdisjoint(ALCOHOLS) == True:
...
def tag_special_ingredients(dish):
    ...
    """
    set_dish = set(dish[1]) & SPECIAL_INGREDIENTS
    tuple_dish = (dish[0],set_dish)
...
def compile_ingredients(dishes):
    ...
    for a in dishes:
        set_of_ingredients = set_of_ingredients | a
